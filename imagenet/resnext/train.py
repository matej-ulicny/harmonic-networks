...
parser.add_argument('--drop-conn', type=float, default=0.0,
                    help='Drop connection rate (default: 0.)')
...
parser.add_argument('--rotation', type=float, default=10,
                    help='Random rotation angle (default: 10)')
...
def main():
    ...
    model = create_model(
        ...
        drop_rate=args.drop,
        drop_connect_rate=args.drop_conn,
        global_pool=args.gp,
        bn_tf=args.bn_tf,
    ...
    try:
        ...
        if os.path.isdir("/dev/shm/imagenet"):
            shutil.rmtree("/dev/shm/imagenet")
        pass
